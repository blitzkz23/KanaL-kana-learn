...
public class StartQuizActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        textViewQuestionCountDown = findViewById(R.id.questionCount);
    ...
    private void showNextQuestion() {
        ...
        if(questionCounter < questionCountTotal){
            ...
            questionCounter++;
            textViewQuestionCountDown.setText("Question : " + questionCounter + "/" + questionCountTotal);
            answered = false;
    ...
    @Override
    //if want to back during quiz acrivity
